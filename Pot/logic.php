    ...
    if(isset($_SESSION['switch']) && ($_POST['guess'] == $_SESSION['switch']) && ($noofattempts<=3)){
        ...
        switch($noofattempts){
            case 1:
                ...
                $_SESSION['Is_User'] = $_SESSION['Is_User'] + 30;
                break;
            case 2:
                $_SESSION['gamedata'][$level]['score'] = 20;
                $_SESSION['Is_User'] = $_SESSION['Is_User'] + 20;
                break;
            case 3:
                $_SESSION['gamedata'][$level]['score'] = 10;
                $_SESSION['Is_User'] = $_SESSION['Is_User'] + 10;
                break;
        }
        echo '{"status": "success","gamestatus":1,"score": '.$_SESSION['Is_User'].',"level": '.$_SESSION['level'].'}';
    }
    else{
